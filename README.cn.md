...
[![x-cmd/install — whosthere Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/whosthere.svg?lang=zh)](https://x-cmd.com/install/whosthere)
...
合计: **11,306** 行代码（覆盖前 5 种语言、共 **114** 个文件）。
...
- **最新版本**: `v0.8.3` (2026-07-23)
- **最近提交**: 2026-09-14
- **Release 含资产**: 11 个

## 流行度

- **Star**: 2,448 · **Fork**: 76 · **开放 issue**: 35 · **贡献者**: 11

## 累计统计

- **发布数**: 16 · **已合并 PR**: 89 · **开放 PR**: 0 · **已关闭 issue**: 28 · **开放 issue**: 7 · **提交数**: 176

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 0 | 2 | 0 | 0 | 0 | 3 |
| last60d | 2026-07-26 | 0 | 5 | 0 | 0 | 0 | 6 |
| 90d | 2026-06-26 | 1 | 11 | 0 | 0 | 1 | 12 |
| last180d | 2026-03-28 | 5 | 40 | 0 | 4 | 3 | 48 |
| 360d | 2025-09-29 | 16 | 89 | 0 | 28 | 7 | 154 |
| last720d | 2024-10-04 | 16 | 89 | 0 | 28 | 7 | 176 |
...
whosthere 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `whosthere` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/whosthere.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:08:52Z._
